...
function direccion()
{
   $con=mysql_query("select * from contenido where tipo='direccion'");   
   $row=mysql_fetch_object($con);
   $contenido=nl2br($row->contenido);
   echo"<br><a class='letras'>$contenido</a><br>";
   mysql_free_result($con);
...
{ global $id;
 ...
 echo"<table width='100%' border='0' cellspacing='4' cellpadding='0'>
      <tr>
        <td height='157' valign='top' class='integrantes'>
  ...
  echo "<img src='archivos/$r->archivo' width='125' height='140'>";}
				  echo"</td>
                  <td width='28%'><img src='../temas/estandar/imagenes/fondofoto.gif' alt='Fondo' width='56' height='141'></td>
                </tr>
                <tr>
                  <td height='1' colspan='2' bgcolor='#89A2BF'></td>
                  </tr>
              </table>
               <br>";
...
function mostrar_docs($iid)
{
 global $p,$id;	
		...
		echo"<img src='../temas/estandar/imagenes/inforel.gif'>"; $inf='si';//imagen e informacion relacionada // y marco con si
...
function contacto()
{  global $m;		
     if($m==1)echo"<div align='center'><a class='mensaje'>Su consulta online fue enviada correctamente, pronto le responderemos.   Gracias!!!</a></div>";  //MENSAJE FUE ENVIADO
     if($m==0)echo"<div align='center'><a class='mensaje'>Su consulta no fue enviada ingrese correctamente los datos.  Gracias!!!</a></div>";  //MENSAJE FUE ENVIADO
...
{
		if($nombre!='' and $correo!='@' and $codigo==$_SESSION["codigo"])
		 {
...
******************************************************************************************
		 ...
		 {
		 echo" <META HTTP-EQUIV='Refresh' CONTENT='0;URL=index.php?p=contacto&m=0'>";exit();
		 }
}
//*******************************************************************************************************
...
<LINK href="../temas/estandar/css.css" rel=stylesheet>
<LINK href="../webpanel/css_panel.css" rel=stylesheet>
<LINK href="../temas/estandar/menu.css" rel=stylesheet>
<script>
navHover = function() {
...
<center>
  ...
  <table width="777" border="0" cellpadding="0" cellspacing="0" class="t_tabla">
    <tr>
      <td colspan="2"><?php logo();?></td>
      <td width="184" height="96">
	  
	  <table width="178" border="0" align="center" cellpadding="10" cellspacing="0" class="direccion">
          <tr>
            <td width="158" height="119" valign="top" class="letras"><?php direccion();?></td>
          </tr>
      </table></td>
    </tr>
    
    <tr>
      <td colspan="2" valign="top" background="../temas/estandar/imagenes/fondohor.gif" bgcolor="#EEEEEE">&nbsp;</td>
      <td valign="top" background="../temas/estandar/imagenes/fondohor.gif">&nbsp;</td>
    </tr>
    <tr>
      <td width="96" valign="top" bgcolor="#EEEEEE">
      <?php 					
echo"				
<ul id='navmenu'>
  <li><a href='index.php'>Inicio</a></li>";
   ...
   while ($row=mysql_fetch_object($res))
	  ...
	  echo"<li><a href='#'>$row->titulo</a></li>";
	        else 
 ...
 echo"</ul>";
		?>     </td>
      <td width="497" valign="top" class="t_1"><?php
echo "<div class='titulos'><br>".seccion($p)."</div>";
?>
        <?php
    if (isset($p))
       { 
    ...
    else
   {
    echo"<table width='100%' border='0' cellpadding='4' cellspacing='0'>
        <tr>
          <td valign='top'>"; 
			 $con=mysql_query("select * from contenido where subtipo='boletin' and habilitado='on' order by id limit 0,1");   	 
			 $row=mysql_fetch_object($con);
			 ...
			 $id=$row->id;
			 echo"<div id='lateral'>      
		  <table width='200' border='0' cellpadding='0' cellspacing='0' class='t_boletin'>
              <tr>
                <td><img src='../temas/estandar/imagenes/boletin.gif' width='205' height='25'></td>
              </tr>
              <tr>
                <td height='285' valign='top' class='t_bol'>";
			 $con=mysql_query("select * from contenido where ide='$id' order by id desc limit 0,10");   	 
			 $i=1;
			 while($row=mysql_fetch_object($con) and $i<=4)
				...
				echo"
		    <a class='letras2'>"; inicio(); echo"</a>	   
        	</td></tr></table>"; 
		}
   ?></td>
      <td valign="top">
        <table width='182' border='0' cellpadding='0' cellspacing='0' class='t_consultas'>
          <form action='index.php' method='post'>
            <tr>
              <td height="21" colspan="2" class='consultas'><span class="t_1"><img src="../temas/estandar/imagenes/consultas.jpg" alt="Consultas Jur&iacute;dicas Online" width="183" height="39"></span></td>
            </tr>
            <tr>
              <td width='4%' class='consultas'>&nbsp;</td>
              <td width='96%' height='21' class='consultas'>Nombre Completo: </td>
            ...
            <tr>
              <td>&nbsp;</td>
              <td><label>
                  <input name='nombre' type='text' class='consultas2' id='nombre' size='28'>
              </label></td>
            </tr>
            <tr>
              <td class='consultas'>&nbsp;</td>
            ...
            <tr>
              <td>&nbsp;</td>
              <td><input name='correo' type='text' class='consultas2' id='correo' value='@' size='28'></td>
            </tr>
            <tr>
              <td class='consultas'>&nbsp;</td>
              <td height='21' class='consultas'>Tel&eacute;fono de Contacto:</td>
            ...
            <tr>
              <td>&nbsp;</td>
              <td><input name='telefono' type='text' class='consultas2' id='telefono' size='28'></td>
            </tr>
            <tr>
              <td class='consultas'>&nbsp;</td>
              <td height='22' class='consultas'>Materia Juridica de la Consulta:</td>
            ...
            <tr>
              <td>&nbsp;</td>
              <td><input name='tema' type='text' class='consultas2' id='tema' size='28'></td>
            </tr>
            <tr>
              <td class='consultas'>&nbsp;</td>
              <td height='21' class='consultas'>Consulta:</td>
            ...
            <tr>
              <td>&nbsp;</td>
              <td><label>
                  <textarea name='mensaje' cols='26' rows='5' class='consultas2'></textarea>
              </label></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td height='37' class='consultas'>Codigo  <?php $_SESSION["codigo"]=rand(1000,9999); echo $_SESSION['codigo']?> <br>
                
               Escriba el codigo : <input type="text" name="codigo" size="7">
              </td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td height='37'><input name='integrante' type='hidden' value='GENERAL'>
                  <input name='contacto_enviar' type='hidden' class='boton' value='Enviar Mensaje'>
                  <input name='contacto_enviar' type='image' src='../temas/estandar/imagenes/consultas_enviar.gif' title='ENVIAR CONSULTA JURIDICA ONLINE'></td>
            </tr>
            <tr>
              <td class='letras'>&nbsp;</td>
              <td height='42' class='letras'>* El env&iacute;o de la consulta mediante este formulario no entabla ninguna relaci&oacute;n jur&iacute;dica cliente/abogado.</td>
            </tr>
            </FORM>
      </table></td>
    </tr>
    ...
    <tr>
      <td height="107" colspan="2" bgcolor="#706E6B" class="derechoteca"><table width="100%" border="0" cellspacing="0" cellpadding="5">
          <tr>
            <td height="57" valign="bottom" class="derechoteca"><a class="l_blanco"><?php echo"<a class='letras'>".pie()."</a>";?></a></td>
          </tr>
          <tr>
            <td height="40" valign="bottom" class="derechoteca"><?php 		
      ...
      <td background="../temas/estandar/imagenes/lupa_fondo.gif"><br>
          <br>
        <div align="center">
            <input name="patron2" type="Text" class="letras" size="20">
            <input name="p2" type="hidden" value="buscar">
            <input name="buscador2"  type="submit"  value=" Buscar ">
        </div></td>
    </tr>
  </table>
